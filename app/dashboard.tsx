...
import { Target, Calendar, Map, Settings, ClipboardList, LogOut } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>{theme === 'redMean' ? 'YOUR BATTLE HUB' : 'Dashboard'}</Text>
        ...
        <View style={styles.content}>
          <View style={styles.card}>
            ...
            {activeGoals.length === 0 ? (
              <Text style={{ color: colors.textSecondary }}>No active goals yet.</Text>
            ) : (
              activeGoals.map((g) => (
            ...
            <View style={styles.grid}>
              <Link href="/(tabs)" asChild>
                <TouchableOpacity style={styles.tile}>
                  <ClipboardList color={colors.primary} />
                  <Text style={styles.tileText}>Log</Text>
                </TouchableOpacity>
              </Link>
              <Link href="/(tabs)/goals" asChild>
                <TouchableOpacity style={styles.tile}>
                  <Target color={colors.primary} />
                  <Text style={styles.tileText}>Goals</Text>
                </TouchableOpacity>
              </Link>
